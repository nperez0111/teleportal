...
import { withPassthroughSink } from "teleportal/transports/passthrough";
...
```typescript
import { createChannel, compose, fromBinaryTransport } from "teleportal/transports";
import { withLogger } from "teleportal/transports/logger";
import { withMessageValidator } from "teleportal/transports/message-validator";
...
```typescript
import { withPassthrough } from "teleportal/transports/passthrough";
