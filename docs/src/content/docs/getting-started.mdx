...
<Tabs>
  <TabItem label="Bun">
    <Code
      code={`mkdir my-teleportal-app && cd my-teleportal-app
bun init -y
...
<Tabs>
  <TabItem label="Bun">
    <Code code="bun run server.ts" lang="bash" />
  </TabItem>
  <TabItem label="Node.js">
    <Code code="node --experimental-strip-types server.ts" lang="bash" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Bun">
    <Code code="bun run client.ts" lang="bash" />
  </TabItem>
  <TabItem label="Node.js">
    <Code code="node --experimental-strip-types client.ts" lang="bash" />
  </TabItem>
</Tabs>
