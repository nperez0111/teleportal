...
import { createEncryptedDriver, UnstorageDocumentStorage } from "teleportal/storage";

// import an existing encryption key
const key = await importEncryptionKey("s1RZEGnuBelCbov-WC6dvddacpT1pzGmhmeVHKr-1Zg");
// create a new random encryption key for at-rest storage
