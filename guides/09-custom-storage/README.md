...
This guide demonstrates how to create a custom storage implementation by extending `AbstractDocumentStorage`. This example shows an in-memory storage that merges updates on-the-fly.
